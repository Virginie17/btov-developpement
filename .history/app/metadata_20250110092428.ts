...
export const homeMetadata: Metadata = {
  ...
  description: 'besoin d unDéveloppeur web freelance à La Rochelle expert en création de sites web sur-mesure et optimisation SEO. Solutions digitales innovantes pour votre entreprise.',
  openGraph: {
