  ...
  return (
    <div className="container mx-auto px-4 py-8 sm:py-16">
      ...
      <div className="relative mb-8">
        <div className="flex overflow-x-auto sm:justify-center gap-4 px-4 -mx-4 sm:mx-0 pb-6 sm:pb-0 no-scrollbar scrollbar-hide">
          <div className="flex gap-4 sm:flex-wrap sm:justify-center min-w-full sm:min-w-0 px-2">
            {categories.map((category) => (
              <button
                key={category.id}
                onClick={() => setSelectedCategory(category.id)}
                className={`flex-none px-5 py-2.5 rounded-full transition-all text-base font-medium shadow-sm whitespace-nowrap ${
        ...
        <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-zinc-300 dark:via-zinc-700 to-transparent sm:hidden" />
      </div>
