...
export const homeMetadata: Metadata = {
  ...defaultMetadata,
  title: 'Expert en Développeur Web à La Rochelle | B to V Développement',
  description: 'Développeur web freelance à La Rochelle, expert en création de sites web sur-mesure et optimisation SEO. Solutions digitales innovantes pour votre entreprise.',
  openGraph: {
