...
export const contactMetadata: Metadata = {
  ...
  description: ' Contactez B to V Développement, developpeur web freelance à La Rochelle,discutons de votre projet de site web pour un devis gratuit. Expert en création de sites web et SEO.',
  openGraph: {
    ...defaultMetadata.openGraph,
