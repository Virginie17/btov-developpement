...
export default function Home() {
  return (
    <>
      <Head>
        <title>Expert en Développement Web & Prompt Engineering | B to V Développement La Rochelle</title>
        <meta name="description" content="Développeur web freelance à La Rochelle, spécialisé en création de sites sur-mesure, optimisation IA, SEO & Prompt Engineering. 10+ ans d'expérience pour booster votre présence en ligne. Contactez-nous pour un devis personnalisé." />
        <meta name="keywords" content="développeur web freelance La Rochelle, création de site web personnalisé La Rochelle, optimisation SEO La Rochelle, Prompt Engineering France, création site e-commerce La Rochelle, référencement naturel La Rochelle, consultant SEO La Rochelle, développement web sur mesure, site internet professionnel La Rochelle, création site internet pour PME La Rochelle, optimisation IA pour entreprise, services développement web La Rochelle" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "sameAs": [
              ...
              "https://www.linkedin.com/in/virginie-chaffard-lucon-327b712a",
