...
const defaultMetadata: Metadata = {
  ...
  title: {
    default: 'developpeur Web freelance à La Rochelle | B to V Développement La Rochelle',
...
export const contactMetadata: Metadata = {
  ...
  description: ' Contactez B to V Développement, developpeur web freelance à La Rochelle,discutons de votre projet de site web des aujourdhui',
  openGraph: {
    ...defaultMetadata.openGraph,
...
export const aboutMetadata: Metadata = {
  ...defaultMetadata,
  title: 'À Propos de B to V Développement |developpeur Web freelance La Rochelle',
  description: 'en savoir plus sur B to V Développement, votre developpeur web freelance à La Rochelle.Expertise en creation de sites web modernes et performants',
  openGraph: {
    ...defaultMetadata.openGraph,
